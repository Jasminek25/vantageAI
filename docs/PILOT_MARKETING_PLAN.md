...
### Days 1–7 — message test

- Run two advisor messages and two family messages.
- Use identical landing-page structure so the message and audience are the main variables.
- Review delivery, policy flags, event accuracy, and obviously unqualified traffic daily.
- Do not make major optimizations during the first 72 hours unless tracking or compliance is broken.

### Days 8–14 — concentrate spend

- Pause only clear underperformers.
- Move budget toward the best combination of audience, message, and channel.
